...
Use o bloco `/lousa` para abrir um canvas Excalidraw embutido diretamente dentro da nota. 

Ideal para diagramas de arquitetura, fluxogramas, wireframes e qualquer coisa que funciona melhor desenhando do que digitando. O conteúdo da lousa é salvo junto com a nota.

---

### 📌 Flashcards com Repetição Espaçada

Qualquer bloco do editor pode ser transformado em flashcard com um clique. O sistema usa o algoritmo de repetição espaçada para agendar quando cada card deve ser revisado.

Ideal para memorizar conceitos, APIs, comandos e sintaxes que você usa com pouca frequência.
