...
const EditorHeader: React.FC<EditorHeaderProps> = ({ noteId }) => {
  ...
  return (
    <div className="w-full pt-2 pb-2 relative group mb-4">
      <input
        type="text"
        className="w-full text-5xl font-black bg-transparent border-none outline-none text-[var(--text-primary)] mb-3 placeholder:text-[var(--text-muted)] placeholder:opacity-30 tracking-tight"
        placeholder="Título..."
        value={note?.title || ''}
