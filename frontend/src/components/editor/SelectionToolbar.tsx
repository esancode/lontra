...
import { Trash2, Copy, Command, X } from 'lucide-react';
...
const SelectionToolbar: React.FC<SelectionToolbarProps> = ({ editor, containerRef }) => {
  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="p-1.5 hover:bg-[var(--accent-red-subtle)] hover:text-[var(--accent-red)] rounded text-[var(--text-secondary)] transition-colors" 
        title="Deletar"
      >
        <Trash2 size={14} />
      </button>
